...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('avalue_robot')
    launch_dir = os.path.join(bringup_dir, 'launch')
    ekf_config = Path(get_package_share_directory('avalue_robot'), 'config', 'ekf.yaml')
    imu_config = Path(get_package_share_directory('avalue_robot'), 'config', 'imu.yaml')
