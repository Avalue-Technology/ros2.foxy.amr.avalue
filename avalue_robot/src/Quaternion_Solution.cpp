...
/**************************************
Date: May 31, 2020
Function: Square root reciprocal Used in quaternion calculations
***************************************/
...
void Quaternion_Solution(float gx, float gy, float gz, float ax, float ay, float az)
{
	...
	{
		// First, convert the velocity sensor's collected values (3D vectors) into unit vectors by dividing each vector by its magnitude
		...
		// The error is the sum of the cross products of the estimated direction of gravity and the measured direction of gravity.
		halfex = (ay * halfvz - az * halfvy);
		halfey = (az * halfvx - ax * halfvz);
		halfez = (ax * halfvy - ay * halfvx);
		// Calculate and apply integral feedback (if enabled)
		if(twoKi > 0.0f)
		{
